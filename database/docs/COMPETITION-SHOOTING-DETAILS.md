...
`database/14_shooting_details.sql` contains the structured physical definition that
the relational Course of Fire previously lacked. It is part of the numbered
fresh-install schema and is not a standalone upgrade.
...
1. `database/14_shooting_details.sql`
2. `database/15_concurrent_shooting.sql`
